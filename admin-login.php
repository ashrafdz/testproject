...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            height: 100vh;
            overflow: hidden; /* Keep overflow hidden to contain the floating elements within the viewport */
        }
        ...
        form {
            ...
            padding: 30px;
            border-radius: 10px;
            box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1); /* Transparent box shadow */
            width: 90%;
            max-width: 400px;
...
<body>
    ...
    <form action="ad-authen.php" method="post">
